    ...
    render() {
        return (
            <Background>
                ...
                <Text style={styles.paragraph}>First player to roll the dice starts the round. Others will then have to roll their dice in 5 seconds before the round ends.</Text>
